        ...
        <div className='lg:w-[35rem] max-lg:w-full shrink-0 flex relative lg:justify-end'>
            <div className='absolute max-lg:h-72 lg:w-[450px] overflow-hidden lg:right-0'>
                <svg className='' width="1023" height="418" viewBox="0 0 1023 418" xmlns="http://www.w3.org/2000/svg" style={{ filter: `drop-shadow(0px 6px 10px ${isCoffee ? "#2A1A12" : isTea ? "#141B0C" : isSnack ? "#5C3412" : "#733324"})` }}>
                    <polygon points="100,0 1023,0 1023,418 0,418" fill={isCoffee ? "#5C4033" : isTea ? "#283618" : isSnack ? "#bc6c25" : "#E97451"} stroke={isCoffee ? "#3E2A1F" : isTea ? "#1e2a16" : isSnack ? "#8C4F1A" : "#b54f38"} className='transition-colors duration-300 ease-in-out' />
                </svg>
            </div>
            <div className='flex items-center gap-1 md:gap-4 mx-2 lg:mx-0 max-lg:h-64'>
                <div className='flex w-1/2 md:w-1/3 lg:w-max items-center mt-5 lg:mt-0 h-full'>
                    {/* <AnimatedContent
                        distance={50}
                        direction="vertical"
                        reverse={false}
                ...
                <div className='h-full flex-1  flex justify-end items-center mt-5 lg:mt-0 mr-2 md:mr-8 lg:mr-4 z-10'>
                    <div className='w-full lg:mr-4 lg:w-64'>
                        <div className="flex justify-between items-center mb-0 lg:mb-1">
                            <h3 className='text-white text-2xl lg:text-3xl font-poppins font-bold max-sm:max-w-[calc(100%-36px)] break-words'>{selectedMenu.menu}</h3>
                        ...
                        <p className='text-white font-poppins font-semibold mt-1'>{formattedPrice}</p>
                    </div>
                </div>
            </div>
        </div>
