...
export default function Button({href, text, direction, reverse, delay}) {
 return (
    <AnimatedContent
        distance={100}
        direction={direction}
        ...
        delay={delay}
    >
        <a href={href} className='flex gap-1 items-center mt-8 px-6 py-3 border border-white text-white font-poppins md:text-xl rounded-lg hover:bg-primary active:bg-primary-dark hover:scale-105 transition cursor-pointer'>
            {text}
